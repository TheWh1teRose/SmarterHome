...
try:
    ...
    font15 = ImageFont.truetype('/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf', 15)
    ...
    # # partial update
    epd.Clear(0xFF)
    font24 = ImageFont.truetype('/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf', 65)
    time_image = Image.new('1', (epd2in13d.EPD_HEIGHT, epd2in13d.EPD_WIDTH), 255)
    time_draw = ImageDraw.Draw(time_image)
    while (True):
        time_draw.rectangle((10, 25, 200, 150), fill = 255)
        time_draw.text((10, 25), time.strftime('%H:%M'), font = font24, fill = 0)
